...
/*
https://github.com/Turfjs/turf/issues/1282
const lineIntersect = require('@turf/line-intersect').default;
https://github.com/rowanwins/turf-builder/issues/18
http://turfjs.org/getting-started

Creating custom builds for use in the browser
1. Create a folder and install whatever modules you are interested in via npm
  npm install @turf/collect @turf/buffer
2. Create a file called main.js in the root directory, in this include your required modules within a modules.exports statement
  module.exports = {
      collect: require('@turf/collect'),
      buffer: require('@turf/buffer')
  };
3. Run the following browserify command (& then uglify)
  browserify main.js -s turf > outTurf.js
  uglifyjs outTurf.js > turf_intersect.min.js
*/

},{"@turf/helpers":2,"@turf/intersect":3,"@turf/invariant":5}],2:[function(require,module,exports){
"use strict";
...
},{"@turf/helpers":4,"@turf/invariant":5,"martinez-polygon-clipping":6}],4:[function(require,module,exports){
...
},{"@turf/helpers":2}],6:[function(require,module,exports){
/**
 * martinez v0.4.3
